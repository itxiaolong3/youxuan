...
!function (a) {
    ...
    var Codeview = function (a) {
        ...
        var b = a.layoutInfo.editor, c = a.layoutInfo.toolbar, d = a.layoutInfo.editable, e = a.layoutInfo.codable,
            f = $(window), g = $("html, body");
        this.toggle = function () {
            var h = function (a) {
        ...
        this.initialize = function () {
            ...
            a.memo("button.style", function () {
                return c.buttonGroup([c.button({
                    ...
                    className: "dropdown-style", items: a.options.styleTags, template: function (a) {
                        ...
                        var b = a.tag, c = a.title, d = a.style ? ' style="' + a.style + '" ' : "",
            ...
            var b, c = 18, d = $(a.target.parentNode), f = d.next(), g = d.find(".note-dimension-picker-mousecatcher"),
        ...
        this.initialize = function () {
            ...
            var b,
                ...
                i = /\/\/(player\.)?vimeo\.com\/([a-z]*\/)*([0-9]{6,11})[?]?.*/, j = a.match(i),
                k = /.+dailymotion.com\/(video|hub)\/([^_]+)[^#]*(#video=([^_&]+))?/, l = a.match(k),
                m = /\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.html/, n = a.match(m), o = /^.+.(mp4|m4v)$/, p = a.match(o),
                q = /^.+.(ogg|ogv)$/, r = a.match(q), s = /^.+.(webm)$/, t = a.match(s);
            if (d && 11 === d[1].length) {
                var u = d[1];
        ...
        var b = this, c = $.summernote.ui, d = 5, e = a.options.hint || [], f = a.options.hintDirection || "bottom",
            g = $.isArray(e) ? e : [e];
        this.events = {
            "summernote.keyup": function (a, c) {
                c.isDefaultPrevented() || b.handleKeyup(c)
