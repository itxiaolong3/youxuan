		...
		<div class="wrapper wrapper-content animated fadeInRight">
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-lg-10">
					...
					<ol class="breadcrumb">
						<li>
							<a href="javascript:history.back(-1)" target="_parent">商品列表</a>
						</li>
							...
							<div id="tab-2" class="tab-pane">
								<div class="panel-body">
									...
									<fieldset class="form-horizontal">
										<input type="hidden" name="gid" value="<?php echo ($classinfo["gid"]); ?>">
										<div class="form-group"><label class="col-sm-2 control-label">商品名称:</label>
											<div class="col-sm-10"><input type="text" class="form-control" name="gtitle" required="required" value="<?php echo ($classinfo["gtitle"]); ?>" placeholder="商品名称"></div>
										</div>
										<div class="form-group"><label class="col-sm-2 control-label">商品简介:</label>
											<div class="col-sm-10"><input type="text" class="form-control" name="gdes" required="required" value="<?php echo ($classinfo["gdes"]); ?>" placeholder="商品简介，广告语"></div>
										</div>
										<div class="form-group"><label class="col-sm-2 control-label">原价/元:</label>
											<div class="col-sm-10"><input type="text" class="form-control" name="gprice" required="required" value="<?php echo ($classinfo["gprice"]); ?>" placeholder="不参加优惠的价格"></div>
										</div>
										<div class="form-group"><label class="col-sm-2 control-label">优惠价格/元:</label>
											<div class="col-sm-10"><input type="text" class="form-control" name="gyhprice" required="required" value="<?php echo ($classinfo["gyhprice"]); ?>" placeholder="实际买卖价格"></div>
										</div>
										<div class="form-group"><label class="col-sm-2 control-label">限量数:</label>
											<div class="col-sm-10"><input type="text" required="required" name="gendnum" class="form-control" value="<?php echo ($classinfo["gendnum"]); ?>"  placeholder="限量用户购买数"></div>
										</div>
										<div class="form-group"><label class="col-sm-2 control-label">提成:</label>
											<div class="col-sm-10"><input type="text" required="required" name="gticheng" class="form-control" value="<?php echo ($classinfo["gticheng"]); ?>"  placeholder="提成"></div>
										</div>
										<div class="form-group"><label class="col-sm-2 control-label">排序:</label>
											<div class="col-sm-10"><input type="number" required="required" name="gorder" class="form-control" value="<?php echo ($classinfo["gorder"]); ?>"  placeholder="默认为0"></div>
										</div>
										<div class="form-group"><label class="col-sm-2 control-label">供应商:</label>
											<div class="col-sm-10"><input type="text" required="required" name="gboss" class="form-control" value="<?php echo ($classinfo["gboss"]); ?>" placeholder="商品供应商"></div>
										</div>
										<div class="form-group"><label class="col-sm-2 control-label">品牌:</label>
											<div class="col-sm-10"><input type="text" required="required" name="gpingpai" class="form-control" value="<?php echo ($classinfo["gpingpai"]); ?>" placeholder="品牌"></div>
										</div>
										<div class="form-group"><label class="col-sm-2 control-label">产地:</label>
											<div class="col-sm-10"><input type="text" required="required" name="gaddress" class="form-control" value="<?php echo ($classinfo["gaddress"]); ?>" placeholder="产地"></div>
										</div>
											...
											<div class="layui-upload">
												...
												<div class="layui-inline col-sm-10" >
													<div class="layui-input-inline">
														<input type="text" class="layui-input" name="gendtime" id="test5" value="<?php echo ($classinfo["gendtime"]); ?>" placeholder="选填">
													</div>
												</div>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="layui-upload col-sm-10">
												...
												<div class="layui-upload-list">
													<?php if($classinfo["gtopimg"] == '' ): ?><input type="hidden" id="file_upload_image" required="required" name="gtopimg" multiple="true" value=""/>
														<div id="showimg">

														</div>
														<p id="demoText"></p>
														<?php else: ?>
														<input type="hidden" id="file_upload_image" required="required" name="gtopimg" multiple="true" value="<?php echo ($classinfo["gtopimg"]); ?>"/>
														<div id="showimg">
															<li>
																<img class='layui-upload-img' id='showone' src="/tp3/youxuan/Public/<?php echo ($classinfo["gtopimg"]); ?>" style='width:100px;height:100px;'>
																<img class='button' onclick="deletefimg('/tp3/youxuan/Public/<?php echo ($classinfo["gtopimg"]); ?>');" id='oneimgclose' src="/tp3/youxuan/Public/images/fancy_close.png">
															</li>
														</div>
										...
										<div class="form-group">
											...
											<div class="layui-upload col-sm-10">
												<div class="layui-upload">
													...
													<?php if($classinfo["gimgs"] == '' ): ?><blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
															预览图：
														...
														<blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
															预览图：
															<div class="layui-upload-list" id="demo3">
																<?php if(is_array($arrs)): $k = 0; $__LIST__ = $arrs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($k % 2 );++$k;?><li id="li<?php echo ($k); ?>"><img class='layui-upload-img'  src="<?php echo ($vv); ?>" style='width:100px;height:100px;'>
																		<img class='button'  onclick="del('<?php echo ($vv); ?>','<?php echo ($k); ?>');" src="/tp3/youxuan/Public/images/fancy_close.png">
																	</li><?php endforeach; endif; else: echo "" ;endif; ?>

															</div>
														</blockquote>
														<input type="hidden" name="gimgs" id="manyimg" value="|<?php echo ($classinfo["gimgs"]); ?>"/><?php endif; ?>
												</div>
											</div>
										</div>
...
<script src="/tp3/youxuan/Public/admin/js/plugins/ladda/ladda.jquery.min.js"></script>
		<script type="text/javascript">
            ...
            var url='/tp3/youxuan/index.php/Superadmin/Goodslist';
		</script>
		<!--时间选择-->
		<script>
            ...
            layui.use('upload', function(){
                ...
                var uploadInst = upload.render({
                    ...
                    ,done: function(res){
                        ...
                        var newElement = "<li><img class='layui-upload-img' id='showone' src='" +"/tp3/youxuan/Public/admin/uploads/"+res.data + "' style='width:100px;height:100px;'><img class='button' id='oneimgclose' src="+window.path+"/images/fancy_close.png></li>";
                        if ($("#file_upload_image").val()){
                                $("#file_upload_image").attr('value',"admin/uploads/"+res.data);
                                $("#showone").attr('src',"/tp3/youxuan/Public/admin/uploads/"+res.data);
                        }else{
                ...
                upload.render({
                    ...
                    ,done: function(res){
                        ...
                        //alert(res);
                        console.log(res);
                        var newElement = "<li><img class='layui-upload-img'  src='" +"/tp3/youxuan/Public/admin/uploads/"+res.data + "' style='width:100px;height:100px;'><img class='button' src="+window.path+"/images/fancy_close.png></li>";
                        $("#demo3").append(newElement);
                        $("img.button").last().bind("click", del);
                        var $svalue=$('#manyimg').val();
                        if($svalue==''){
                            $('#manyimg').val("|"+"/tp3/youxuan/Public/admin/uploads/"+res.data);
                        }else{
                            $('#manyimg').val($svalue+"|"+"/tp3/youxuan/Public/admin/uploads/"+res.data);
                        }
                        console.log('打印我');
