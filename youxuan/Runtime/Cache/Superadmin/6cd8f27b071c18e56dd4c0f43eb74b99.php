...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div style="margin-top: 50px;">
            ...
            <form class="m-t" role="form" action="/tp3/youxuan/index.php/Superadmin/User/mylogin" method="post">
                ...
                <div class="form-group">
                    <img src="/tp3/youxuan/index.php/Superadmin/User/VerifyImg" width="100%" height="35px" title="点击更新验证码" alt="点击更新认证码" onClick="this.src='/tp3/youxuan/index.php/Superadmin/User/VerifyImg/'+Math.random()" />
                </div>
