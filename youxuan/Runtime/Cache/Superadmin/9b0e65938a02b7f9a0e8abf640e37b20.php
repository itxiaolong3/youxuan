											...
											<div class="table-responsive">
												<table class="table table-striped  dataTables-example">
													...
													<?php if(is_array($info)): foreach($info as $key=>$v): ?><tr class="gradeX">
														...
														<td><img src="/tp3/youxuan/Public/<?php echo ($v["dheaderimg"]); ?>" width="60" height="60" /></td>
														<td><?php echo ($v["dname"]); ?></td>
														<td><?php echo ($v["dphone"]); ?></td>
														<td><?php echo ($v["dpassword"]); ?></td>
														...
														<td><img src="/tp3/youxuan/index.php/Superadmin/Shoplist/getqrcorde?sid=<?php echo ($v["did"]); ?>" width="60" height="60" /></td>
														<!--/tp3/youxuan/index.php/Superadmin-->
														<!--/tp3/youxuan-->
														<td>
															...
															<a class="btn btn-primary btn-xs"  href="/tp3/youxuan/index.php/Superadmin/Shoplist/editshop?did=<?php echo ($v["did"]); ?>" target="main" style="margin-top: 10px;">修改</a>
