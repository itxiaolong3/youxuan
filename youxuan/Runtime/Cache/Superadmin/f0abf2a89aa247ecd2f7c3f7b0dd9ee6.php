						...
						<div class="form-group">
							...
							<div class="layui-upload col-sm-10">
								...
								<div class="layui-upload-list">
									...
									<a href="javascript:deleteqrcodeimg();" title="点击删除"><img style="display: none;margin-left: 120px;" id="deleteqrcode" src="/youxuan/youxuan/Public/admin/js/img/uploadify-cancel.png">
									</a>
...
<script src="/youxuan/youxuan/Public/admin/js/plugins/ladda/ladda.jquery.min.js"></script>
		...
		<script type="text/javascript">
            ...
            var url='/youxuan/youxuan/index.php/Superadmin/Addshop';
		</script>
